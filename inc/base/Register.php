...
class Register extends BaseController {
  ...
  public function enqueue() {
    ...
    $this->enqueueStyle( 'theme-init', '1.0.10' );
    ...
    if ( is_front_page() ) {
      $this->enqueueScript( 'gpw-home-page', '1.0.6', true );
      $this->enqueueStyle( 'gpw-home-page', '1.0.16' );
    }
    ...
    if ( is_page( [13, 2695] ) ) {
      $this->enqueueScript( 'gpw-about-page', '1.0.4', true );
      $this->enqueueStyle( 'gpw-about-page', '1.0.9' );
    }
