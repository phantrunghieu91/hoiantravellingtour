...
<footer id="footer" class="footer" 
	<?php if ( $footerBgID ) : ?> style="background-image: url('<?php echo esc_url( wp_get_attachment_image_url( $footerBgID, 'full' ) ); ?>');" <?php endif; ?>
>


	<?php get_template_part( 'gpw-templates/footer/fixed-social-icons-block' ) ?>
