 ...
 * * Template: Industry archive page
 */
...
get_template_part( 'gpw-templates/global/services-section', null, ['title' => __('Industries', 'gpw')] );

get_template_part( 'gpw-templates/global/get-free-quote-section' );

get_template_part( 'gpw-templates/global/testimonial-section');

get_template_part( 'gpw-templates/home-page/blogs-section', null, [ 'class' => 'related-posts'] );
